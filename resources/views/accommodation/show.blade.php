      ...
      <div class="col-lg-4">
        <div class="p-4 rounded shadow-sm booking-card" style="background:#020c28;">
          ...
          <form action="{{ route('booking.store') }}" method="POST" class="row g-3">
            ...
            <div class="col-12">
              <label class="form-label small text-white">Telepon (opsional)</label>
...
{{-- FIX STYLE: pastikan teks input/select tetap gelap di atas background gelap --}}
@push('styles')
    <style>
    .booking-card label,
    .booking-card h4,
    ...
    .booking-card ::placeholder { color:#6b7280; } /* abu */
    </style>
@endpush
@endsection
