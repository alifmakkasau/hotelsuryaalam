...
<section class="about_area section_gap" style="margin-bottom: 100px;">
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-10" data-aos="fade-up" data-aos-delay="150" data-aos-duration="1000">
        ...
        <div class="row align-items-center gy-4 mt-4">
            ...
            <div class="col-lg-6 col-md-12 text-center" data-aos="zoom-in" data-aos-duration="1000">
                <figure class="m-0">
                    <img src="<?php echo e(asset('template/image/aboutpage.jpg')); ?>"
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HotelSuryaAlam\resources\views/about.blade.php ENDPATH**/ ?>