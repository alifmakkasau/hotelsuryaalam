    ...
    <div class="row mb-5">
        <div class="col-md-6">
            ...
            <p style="font-size:16px; line-height:1.6;">
                ...
                <strong>Nomor Telepon:</strong> 0853-4840-4764
            </p>
        </div>
        ...
        <div class="col-md-6">
            ...
            <div
                style="width:100%; height:300px; border-radius:10px; overflow:hidden; box-shadow:0 3px 10px rgba(0,0,0,0.2);">
                 <iframe 
...
<!-- Styling tambahan --> 
 <style> .form-control { border-radius: 8px; border: 1px solid #ccc; padding: 12px; font-size: 15px; transition: all 0.3s ease; } .form-control:focus { border-color: #0b1f3a; box-shadow: 0 0 5px rgba(11, 31, 58, 0.3); } textarea.form-control { resize: none; } .btn:hover { background-color: #1b3f6b !important; } </style>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HotelSuryaAlam\resources\views/contact.blade.php ENDPATH**/ ?>