...
<?php $__env->startSection('title', 'Accommodation - Hotel Surya Alam'); ?>
                    ...
                    <div class="accomodation_item text-center shadow-sm rounded" style="border: 1px solid #eee;">
                        <div class="hotel_img position-relative">
                            <?php if($room->images->isNotEmpty()): ?>
                                <img src="<?php echo e(asset('storage/' . $room->images->first()->path)); ?>" 
                                    alt="<?php echo e($room->name); ?>" 
                                    class="img-fluid rounded-top">
                            <?php else: ?>
                                <img src="<?php echo e(asset('template/image/room1.jpg')); ?>" 
                                    alt="Default Room" 
                                    class="img-fluid rounded-top">
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\HotelSuryaAlam\resources\views/accomodation.blade.php ENDPATH**/ ?>